...
write.csv(filter_3, file = paste0("./DEA/", "filter3_", title,".csv", sep = ""))
write.csv(filter_2, file = paste0("./DEA/", "filter2_", title,".csv", sep = ""))
write.csv(filter_1, file = paste0("./DEA/", "filter1_", title,".csv", sep = ""))
}
#contrasts
