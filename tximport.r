...
pca_rld
ggsave( pca_rld, filename = "./PCA_RLD.png",units = "cm",width = 20*1.3, height = 20,dpi = 320)
...
pca_ruv_vst <- plotPCA(ruv_vst, intgroup ='Condition') +
  ...
  theme( text = element_text(size=22), 
         ...
         plot.title = element_text(hjust = 0.5),
         axis.line = element_line(colour = "black") )
ggsave( pca_ruv_vst, filename = "./PCA_RUV-VST-CONDITION.png",units = "cm",width = 20*1.3, height = 20,dpi = 320)

# PCA RUV RLD CONDITION
...
pca_ruv_rld <- plotPCA(ruv_rld, intgroup ='Condition') +
  ...
  theme( text = element_text(size=22), 
         ...
         plot.title = element_text(hjust = 0.5),
         axis.line = element_line(colour = "black") )
ggsave( pca_ruv_rld, filename = "./PCA_RUV_RLD-CONDITION.png",units = "cm",width = 20*1.3, height = 20,dpi = 320)
