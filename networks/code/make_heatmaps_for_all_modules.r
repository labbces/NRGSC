...
dat_list <- list()
for (i in Nmods$'Mod No'){
dat_list[[i]] <- eval(as.name(paste0("module",i,"_dat")))
}
...
png(paste0("/Storage/data1/jorge.munoz/NRGSC.new/networks/results/perNCONDITION/COLOR_OK_HEATMAPS/", "color_ok_hp_samples_module_", i, ".png", sep = ""), res = 300, width = 6.5*800, height = 1.5*2850)
pheatmap(df,
...
png(paste0("/Storage/data1/jorge.munoz/NRGSC.new/networks/results/perNCONDITION/COLOR_OK_HEATMAPS/", "color_ok_hp_grouped_module_" , i, ".png", sep = ""), res = 300, width = 3*800, height = 1.5*2850)
